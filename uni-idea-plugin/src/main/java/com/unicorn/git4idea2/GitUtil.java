...
import com.unicorn.git4idea2.repo.GitRepositoryManager;
...
public class GitUtil {
  ...
  private static Map<GitRepository, List<VirtualFile>> sortFilesByRepository(@NotNull Project project,
                                                                             ...
                                                                             boolean ignoreNonGit)
    throws VcsException {
    GitRepositoryManager manager = GitRepositoryManager.Companion.getInstance(project);
  ...
  public static GitRepositoryManager getRepositoryManager(@NotNull Project project) {
    GitRepositoryManager instance = GitRepositoryManager.Companion.getInstance(project);
    return instance;
  }
  ...
  public static GitRepository getRepositoryForFile(@NotNull Project project, @NotNull VirtualFile file) throws VcsException {
    GitRepository repository = GitRepositoryManager.Companion.getInstance(project).getRepositoryForFile(file);
  ...
  public static GitRepository getRepositoryForRoot(@NotNull Project project, @NotNull VirtualFile root) throws VcsException {
    GitRepository repository = GitRepositoryManager.Companion.getInstance(project).getRepositoryForRoot(root);
