 ...
 * @author yole
 */
public class PsiImplementationViewSession2 implements ImplementationViewSession {
  private static final Logger LOG = Logger.getInstance(PsiImplementationViewSession2.class);
  ...
  public PsiImplementationViewSession2(@NotNull Project project, @Nullable PsiElement element, PsiElement[] impls, String text,
    ...
    if (ApplicationManager.getApplication().isUnitTestMode()) {
      return new ImplementationSearcher() {
        ...
        protected PsiElement[] filterElements(PsiElement element, PsiElement[] targetElements) {
          return PsiImplementationViewSession2.filterElements(targetElements);
        }
      };
    }
  ...
  @Nullable
  public static PsiImplementationViewSession2 create(@NotNull DataContext dataContext,
    ...
    return new PsiImplementationViewSession2(project, element, impls, text, editor,
