...
public final class FavoriteTreeNodeDescriptor2 extends PresentableNodeDescriptor<AbstractTreeNode<?>> {
  private final AbstractTreeNode<?> myElement;
  public static final FavoriteTreeNodeDescriptor2[] EMPTY_ARRAY = new FavoriteTreeNodeDescriptor2[0];

  public FavoriteTreeNodeDescriptor2(@NotNull Project project, final NodeDescriptor parentDescriptor, final AbstractTreeNode element) {
  ...
  public boolean equals(Object object) {
    if (!(object instanceof FavoriteTreeNodeDescriptor2)) return false;
    return ((FavoriteTreeNodeDescriptor2)object).getElement().equals(myElement);
  }
  ...
  @Nullable
  public FavoriteTreeNodeDescriptor2 getFavoritesRoot() {
    FavoriteTreeNodeDescriptor2 descriptor = this;
    while (descriptor != null && descriptor.getParentDescriptor() instanceof FavoriteTreeNodeDescriptor2) {
      FavoriteTreeNodeDescriptor2 parent = (FavoriteTreeNodeDescriptor2)descriptor.getParentDescriptor();
