...
public abstract class SpeedSearchBase2<Comp extends JComponent> extends SpeedSearchSupply2 {
  private static final Logger LOG = Logger.getInstance(SpeedSearchBase2.class);
  ...
  public SpeedSearchBase2(@NotNull Comp component) {
  ...
  @NotNull
  protected SpeedSearchBase2<Comp>.SearchPopup createPopup(String s) {
  ...
  protected class SearchField extends ExtendableTextField {
    SearchField() {
      setFocusable(false);
      Extension leftExtension = new Extension() {
        @Override
  ...
  private final boolean myElementAtImplemented;
  {
    ...
    try {
      elementAtImplemented = getMethodDeclaringClass(getClass(), "getElementAt", Integer.TYPE) != SpeedSearchBase2.class;
    }
    catch (Exception ex) {
    ...
    try {
      elementCountImplemented = getMethodDeclaringClass(getClass(), "getElementCount") != SpeedSearchBase2.class;
      elementIteratorImplemented = getMethodDeclaringClass(getClass(), "getElementIterator", Integer.TYPE) != SpeedSearchBase2.class;
    }
  ...
  private static final class MyListIterator implements ListIterator<Object> {
    private final SpeedSearchBase2<?> mySpeedSearch;
    private int myCurrentIndex;
    private final int myElementCount;

    private Object[] myElements;

    MyListIterator(@NotNull SpeedSearchBase2<?> speedSearch, int startIndex) {
