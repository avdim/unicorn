...
public class SyntheticLibraryElementNode2 extends ProjectViewNode2B<SyntheticLibrary> implements NavigatableWithText {
  @NotNull private final ItemPresentation myItemPresentation;

  public SyntheticLibraryElementNode2(@NotNull Project project, @NotNull SyntheticLibrary library,
