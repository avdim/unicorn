...
public class NamedLibraryElementNode2 extends ProjectViewNode2B<NamedLibraryElement> implements NavigatableWithText {
  public NamedLibraryElementNode2(Project project, @NotNull NamedLibraryElement value, ViewSettings viewSettings) {
    ...
    if (libraryElement != null) {
      ...
      for (final VirtualFile file : files) {
        ...
        if (file.isDirectory()) {
          ...
          children.add(new PsiDirectoryNode2(project, psiDir, this.getSettings()));
        }
        else {
          final PsiFile psiFile = psiManager.findFile(file);
          if (psiFile == null) continue;
          children.add(new PsiFileNode2(project, psiFile, this.getSettings()));
        }
      }
    }
    return children;
