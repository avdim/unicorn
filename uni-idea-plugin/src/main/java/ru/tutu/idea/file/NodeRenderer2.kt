...
open class NodeRenderer2 : ColoredTreeCellRenderer2() {
        ...
        if (p0 is PresentationData) {
            ...
            if (coloredText.isEmpty()) {
                ...
                val simpleTextAttributes = getSimpleTextAttributes(
                    presentation, forcedForeground ?: color, node!!
                )
    ...
    protected fun getSimpleTextAttributes(
    ...
    companion object {
        ...
        fun getSimpleTextAttributes(presentation: ItemPresentation?): SimpleTextAttributes {
            return getSimpleTextAttributes(presentation, scheme)
        }
