...
import de.halirutan.keypromoterx2.KeyPromoterBundle;
...
public class KPXStartupDialog extends DialogWrapper {
  ...
  private String loadMessageText() {
    ...
    final InputStream stream = classLoader.getResourceAsStream("de/halirutan/keypromoterx2/tips/Message.html");
    if (stream != null) {
